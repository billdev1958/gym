...
public class AdminServiceImpl implements IAdminService {
    ...
    public AdminServiceImpl(IUsersJpaRepository userRepository, IAccountJpaRepository accountRepository, ICatRoleJpaRepository catRoleRepository, PasswordEncoder passwordEncoder) {
    ...
    public User registerNewAdmin(User user, Account account) {
        CatRole adminRole = findRoleByName("ADMINISTRADOR")
    ...
    public List<Account> findAllAdmins() {
        return accountRepository.findAllByUserRoleName("ADMINISTRADOR");
    }
    ...
    public List<User> findUsersByNameAndLastname(String name, String lastname1) {
        return userRepository.findByNameAndLastName(name, lastname1);
    }
